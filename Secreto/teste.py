...
def main():
    ...
    images = {
        'Imagem Original Nossa': cleaned_mask,
        'Imagem Limpa (Sem Pequenos Componentes) Nossa': road_mask,
    }
    plot_images(images)
    ...
    # Mostrar contours
    plot_images({'Contornos': cv.drawContours(np.zeros_like(opening), contours, -1, 255, 1)})
