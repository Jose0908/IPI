...
def main():
    ...
    img_brasilia = cv.imread('../Imagens/rodovia-brasilia3.png', cv.IMREAD_COLOR)
    ...
    # Mostrar a imagem 
    plot_images({'Imagem em Escala de Cinza': gray_nossa})
    ...
    # Mostrar a imagem thresholded_nossa
    plot_images({'Imagem Thresholded Nossa': thresholded_nossa})
    ...
    min_area = 170  # Ajuste o valor conforme necessário
    ...
    opening_nossa = cv.morphologyEx(dilated_image_nossa2, cv.MORPH_OPEN, kernel)

    # Mostrar a imagem opening_nossa
    plot_images({'Imagem Opening Nossa': opening_nossa})
    ...
    output2 = cv.subtract(dilated_image_nossa2, output2)
